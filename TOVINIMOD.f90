SUBROUTINE TOVINIMOD(RHOVAR)
  ...
  !
  ! From SYSTEM:
  ! GR = logical parameter (.True. = GR; .False. = STT)
...
!  REAL,PARAMETER :: RHOSURFTOV=1.0E-8,PSURF=1.0D-15
  REAL,PARAMETER :: RHOSURFTOV=1.0E-17,PSURF=1.0D-21
!  REAL,PARAMETER :: RHOSURFTOV=2.0E-18,PSURF=1.0D-21
  REAL :: RHOVAR
  ...
  ! ====== Begin searching for a solution using double shooting method ==============
